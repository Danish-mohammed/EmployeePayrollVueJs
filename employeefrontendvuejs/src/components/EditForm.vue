    ...
    <div className="payroll-main">
      ...
      <div className="form-content">
        <form className="form-head" action="#" @submit="submitForm">
          <div className="form-head">Update Employee Payroll</div>
            ...
            <div className="profile-radio-content">
              <label>
                <input
                  type="radio"
                  name="profilePic"
                  value="../assets/Ellipse-1.png"
                  v-model="formValues.profilePic"
                /><img src="../assets/Ellipse-1.png" alt="Profile1" />
              </label>
              <label>
                <input
                  type="radio"
                  ...
                  v-model="formValues.profilePic"
                /><img src="../assets/Ellipse-5.png" alt="Profile2" />
              </label>
              <label>
                <input
                  type="radio"
                  name="profilePic"
                  value="../assets/Ellipse-8.png"
                  v-model="formValues.profilePic"
                /><img src="../assets/Ellipse-8.png" alt="Profile3" />
              </label>
              <label>
                <input
                  type="radio"
                  ...
                  v-model="formValues.profilePic"
                /><img src="../assets/Ellipse-4.png" alt="Profile4" />
              </label>
            </div>
          </div>
          <div className="row-content">
          ...
          <div className="buttonParent">
            <router-link to="/">
              <button type="submit" className="resetButton button cancelButton">
                Cancel
              </button></router-link
            >
            ...
            <div className="submit-reset">
              ...
              <button type="button" className="resetButton button">
                Reset
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    submitForm(event) {
      ...
      EmployeeService.updateEmployee(this.formValues.id, this.formValues)
        .then((response) => {
